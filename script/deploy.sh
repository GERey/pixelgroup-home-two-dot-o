...
[
    {
        "name": "uwsgi",
        "image": "gerey/pixelgroup-home-two-dot-o-uwsgi:$tag",
        "essential": true,
        "memory": 200,
        "cpu": 10
    },
    {
        ...
        "image": "gerey/pixelgroup-home-two-dot-o-nginx:$tag",
        "portMappings": [
            {
                "containerPort": 8000,
                "hostPort": 80
...
deploy() {
    service="$1"
    family="pixelgroup-home-two-dot-o"
    cluster="pixelgroup-home-two-dot-o"
...
case "$1" in
    staging) deploy "pixelgroup-home-two-dot-o-staging" ;;
    prod) deploy "pixelgroup-home-two-dot-o" ;;
esac
